...
export default {
  forbidden: [
    ...
    },
    {
      ...
      severity: 'error',
      comment:
        'API, defaults, import logic, surge math, and CA-action mapping stay independent from React UI modules.',
      from: { path: '^src/(?:api|caAction|defaults|importers|surge)[.]ts$' },
