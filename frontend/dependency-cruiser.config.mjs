...
export default {
  forbidden: [
    ...
    },
    {
      ...
      severity: 'error',
      comment:
        'API, defaults, import logic, surge math, usage-stat edits, and CA-action mapping stay independent from React UI modules.',
      from: { path: '^src/(?:api|caAction|defaults|importers|surge|usage)[.]ts$' },
